    ...
    <section id="facilities" className="scroll-target max-w-[1360px] mx-auto px-[clamp(18px,4vw,56px)] py-[clamp(64px,9vw,140px)]">
      ...
      <div className="grid lg:grid-cols-2 gap-[clamp(28px,4vw,60px)] items-start">
        <Reveal className="relative rounded-3xl overflow-hidden aspect-[4/5]">
          <Image src="/images/facilities-ground.jpg" alt="Bowler mid-delivery with batsman, umpire and fielders on the Cross Maidan ground" fill sizes="(min-width: 1024px) 620px, 100vw" className="object-cover" />
